    ...
    <div className="App">
      <div class="MuiBox-root jss37">
        <div class="MuiBox-root jss38">
          <a aria-current="page" class="jss5" href="index.htm">
            <svg
              class="jss7"
              width="184"
              height="41"
        ...
        <div class="MuiBox-root jss39">
          <div class="MuiBox-root jss40 jss9">
            ...
            <div class="MuiBox-root jss47">
              <button
                class="MuiButtonBase-root MuiButton-root MuiButton-text jss11 MuiButton-textSecondary"
                tabindex="0"
                type="button"
              >
